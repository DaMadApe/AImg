...
class BotAleatorio:
    ...
    Escoge aleatorio entre movimientos válidos
    """
...
class BotAleatorioAvaro:
    """
    Escoge aleatoriamente entre tiros válidos, pero
    toma la primera oportunidad que encuentra para cerrar
    un cuadro y anotar
    """
    def __init__(self, game):
        self.game = game
...
class Humano:
    """
    Interfaz para que juegue una persona en la terminal
    """
    def __init__(self, game):
        self.game = game
        print("Timbiriche")
