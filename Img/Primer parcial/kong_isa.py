...
def kong_isa(img, DR=0.7, BR=0.2, blur=10):
    """
    Histogram based Image Enhancement for Non-uniformly
    Illuminated and Low Contrast Images, Kong & Isa, 2015
    """
    ...
    # Asignar así para preservar la forma de la matriz con ceros en huecos
    ...
    Lt = 255 # No es claro en el paper si este debe ser el valor
...
Pruebas
"""
img = io.imread('datos/ultrasonido/ultra5.jpg')
...
# Método propuesto
DR = -0.2 # Aclaramiento de oscuros
